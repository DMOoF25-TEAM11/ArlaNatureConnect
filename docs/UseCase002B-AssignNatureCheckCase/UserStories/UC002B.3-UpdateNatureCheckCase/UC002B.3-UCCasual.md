...
- If consultant changed, a database notification is created for the new consultant.  
...
11. If consultant changed:
    11a. The system creates a notification for the new consultant.
    11b. The system may mark the old consultant's notification as read or remove it.
