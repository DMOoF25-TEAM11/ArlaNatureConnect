...
classDiagram
    ...
    namespace ArlaNatureConnect.Domain.Entities {
        ...
        %% Note: Notification is NOT a domain entity in EF Core implementation
    ...
    namespace ArlaNatureConnect.Core.DTOs {
        ...
        %% Note: ConsultantNotificationDto exists but is used in UC002B.6, not UC002B.2
        %% Notifications are generated from NatureCheckCase data, not stored as entities
    }
    ...
    namespace ArlaNatureConnect.Core.Abstract {
        ...
        %% Note: No INotificationRepository in EF Core implementation
        %% Notifications are generated from NatureCheckCase data in service layer
    }
    ...
    %% Note: Notifications are not entities - they are DTOs generated from NatureCheckCase data
```
