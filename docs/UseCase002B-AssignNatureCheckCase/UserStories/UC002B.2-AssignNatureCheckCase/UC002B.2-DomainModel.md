...
classDiagram
    ...
    %% New relationships for UC002B.2 (Assignment)
...
- When a case is assigned, it creates a notification for the consultant
...
- **Notification Generation** - Creating a notification for the assigned consultant
